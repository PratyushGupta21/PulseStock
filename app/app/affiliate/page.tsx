  ...
  return (
    <ContentPageLayout>
      ...
      <p className="text-[#9a9a9a] text-lg mb-12 leading-relaxed">
        Earn bonus SUSD and leaderboard rewards by referring new traders to PulseStock on Monad Testnet.
      </p>
      ...
      <section className="mb-8">
        <div className="border border-white/10 bg-zinc-950/60 rounded-xl p-8">
          ...
          <p className="text-[#9a9a9a] text-sm leading-relaxed mb-6">
            The PulseStock referral program rewards users who bring new traders to the platform. Since all assets are testnet tokens, referral rewards are distributed in SimUSD (SUSD) and leaderboard points.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-black rounded-lg border border-white/10 p-5 text-center">
              ...
              <p className="text-[#9a9a9a] text-xs">When your referral connects their wallet, claims SUSD, and executes their first trade, the referral is activated.</p>
            </div>
            <div className="bg-black rounded-lg border border-white/10 p-5 text-center">
              <div className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center mx-auto mb-3">
              ...
              <p className="text-[#9a9a9a] text-xs">Both you and your referral receive bonus SUSD and leaderboard points upon activation.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="py-3 px-4 text-[#9a9a9a] text-xs font-mono uppercase">Reward (SUSD)</th>
              ...
              <tbody className="text-sm">
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-4 text-white font-mono">10,000 SUSD</td>
                ...
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-4 text-white font-mono">15,000 SUSD</td>
                ...
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-4 text-white font-mono">25,000 SUSD</td>
                ...
                <tr>
                  ...
                  <td className="py-3 px-4 text-white font-mono">50,000 SUSD</td>
      ...
      <section>
        <div className="border border-white/10 bg-zinc-950/60 rounded-xl p-8">
          ...
          <ul className="space-y-2 text-[#9a9a9a] text-sm">
            <li>• All rewards are distributed in SimUSD (SUSD), a testnet token with no real monetary value.</li>
